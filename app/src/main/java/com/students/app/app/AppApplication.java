...
import com.students.app.aop.Log;
import com.students.app.http.api.ContactDetailsApi;
import com.students.app.http.glide.GlideApp;
import com.students.app.http.model.RequestHandler;
import com.students.app.http.model.RequestServer;
import com.students.app.other.AppConfig;
import com.students.app.other.CrashHandler;
import com.students.app.other.DebugLoggerTree;
import com.students.app.other.TitleBarStyle;
import com.students.app.other.ToastLogInterceptor;
import com.students.app.other.ToastStyle;
import com.hjq.bar.TitleBar;
import com.hjq.gson.factory.GsonFactory;
import com.hjq.http.EasyConfig;
import com.hjq.toast.ToastUtils;
import com.students.umeng.UmengClient;
...
public final class AppApplication extends Application {
    ...
    public static void initSdk(Application application) {
        ...
        //初始化SP
        SPStaticUtils.setDefaultSPUtils(SPUtils.getInstance(AppUtils.getAppName()));

        // 设置标题栏初始化器
        TitleBar.setDefaultStyle(new TitleBarStyle());

        // 设置全局的 Header 构建器
        SmartRefreshLayout.setDefaultRefreshHeaderCreator((context, layout) -> new MaterialHeader(context).setColorSchemeColors(ContextCompat.getColor(context, R.color.common_accent_color)));
        // 设置全局的 Footer 构建器
        ...
        if (connectivityManager != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            connectivityManager.registerDefaultNetworkCallback(new ConnectivityManager.NetworkCallback() {
                ...
                public void onLost(@NonNull Network network) {
                    ...
                    ToastUtils.show(R.string.当前网络不可用请检查网络设置);
                }
            });
        }
    }
