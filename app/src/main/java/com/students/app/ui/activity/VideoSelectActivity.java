...
import com.students.app.manager.ThreadPoolManager;
import com.students.app.other.GridSpaceDecoration;
import com.students.app.ui.adapter.VideoSelectAdapter;
...
import com.students.widget.view.FloatActionButton;
    ...
    public void onChildClick(RecyclerView recyclerView, View childView, int position) {
        if (childView.getId() == R.id.fl_video_select_check) {
            ...
            if (mMaxSelect == 1 && mSelectVideo.size() == 1) {
                ...
                toast(String.format(getString(R.string.本次最多只能选择N个视频), mMaxSelect));
            }
            mAdapter.notifyItemChanged(position);
        }
    }
