package com.students.app.widget;
...
import com.students.base.action.ActivityAction;
import com.students.app.R;
import com.students.app.ui.dialog.MessageDialog;
import com.students.widget.layout.SimpleLayout;
import com.students.widget.view.PlayButton;
...
public final class PlayerView extends SimpleLayout
    ...
    public boolean onInfo(MediaPlayer player, int what, int extra) {
        switch (what) {
            ...
            case MediaPlayer.MEDIA_INFO_BUFFERING_START:
                ...
                mMessageView.setText(R.string.加载中);
    ...
    public boolean onError(MediaPlayer player, int what, int extra) {
        ...
        if (what == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK) {
            message = activity.getString(R.string.该视频不适合在此设备上播放);
        } else {
            message = activity.getString(R.string.无法播放此视频);
        }
        message += "\n" + String.format(activity.getString(R.string.错误类型), what, extra);

        new MessageDialog.Builder(getActivity())
                .setMessage(message)
                .setConfirm(R.string.确定)
                .setCancel(null)
                .setCancelable(false)
